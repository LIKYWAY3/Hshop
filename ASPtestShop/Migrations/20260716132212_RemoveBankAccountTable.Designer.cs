...
namespace ASPtestShop.Migrations
{
    ...
    [Migration("20260716132212_RemoveBankAccountTable")]
    partial class RemoveBankAccountTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ASPtestShop.Data.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("ASPtestShop.Data.Entities.Cart", b =>
                {
            ...
            modelBuilder.Entity("ASPtestShop.Data.Entities.CartItem", b =>
                {
            ...
            modelBuilder.Entity("ASPtestShop.Data.Entities.OrderItem", b =>
                {
            ...
            modelBuilder.Entity("ASPtestShop.Data.Entities.Payment", b =>
                {
            ...
            modelBuilder.Entity("ASPtestShop.Data.Entities.Product", b =>
                {
                    b.Property<int>("ProductId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ASPtestShop.Data.Entities.ProductImage", b =>
                {
            ...
            modelBuilder.Entity("ASPtestShop.Data.Entities.Review", b =>
                {
            ...
            modelBuilder.Entity("ASPtestShop.Models.Entities.UserAddress", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ASPtestShop.Data.Entities.CartItem", b =>
                {
                    b.HasOne("ASPtestShop.Data.Entities.Cart", "Cart")
                        .WithMany("CartItems")
            ...
            modelBuilder.Entity("ASPtestShop.Data.Entities.OrderItem", b =>
                {
                    b.HasOne("ASPtestShop.Data.Entities.Order", "Order")
                        .WithMany("OrderItems")
            ...
            modelBuilder.Entity("ASPtestShop.Data.Entities.Payment", b =>
                {
                    b.HasOne("ASPtestShop.Data.Entities.Order", "Order")
                        .WithOne("Payment")
                        .HasForeignKey("ASPtestShop.Data.Entities.Payment", "OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ASPtestShop.Data.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
